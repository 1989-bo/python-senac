...
print('Olá mundo')
#falta de parenteses e complemento das aspas
...
soma = a + b
print("A soma é: ", soma)
#colocado virgula para ativar variavél 
...
#incluso sinal de igual para sinalizar igualdade, colocado parenteses para ser realizado calculo, colocado dois pontos no else, e feito o tab para sinalizar a função. 

# Exercício 4: Lista e loop
lista = [1, 2, 3, 4, 5]
for i in lista:
 print(i)
 #feito a declaração de repetição para a lista e comando para imprimir
...
#tab para colocar atribuição no código
...
#correção das funções utilizando tab
...
#correção da impressão utilizando tab
...
print(pessoa["nome"])
#colocado aspas para declarar nome
...
#colocado tab em maior para declarar abaixo da função IF
...
#feita correção das funções com tab 
...
#tab para colocar funções em seus lugares
